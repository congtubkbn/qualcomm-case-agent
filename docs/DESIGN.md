...
> Source fingerprint `78151656b91e` over 68 files.
...
| `.claude/skills/qcomm/scripts/finalize_case.mjs` | 977 | Persistence post-processor for the AGENT-DRIVEN extraction. |
...
| `tests/qcomm_finalize_case.test.mjs` | 1269 | Tests for the finalizer — the module that decides what gets persisted. |
