...
> Source fingerprint `de5f84f2d4a7` over 86 files.
...
| `.claude/skills/qcomm/scripts/run_summary.mjs` | 401 | orchestrator for qcomm summary. |
...
| `tests/qcomm_summary_orchestrator.test.mjs` | 491 | Tests for qcomm's orchestrator (prepare/finalize). |
