...
> Source fingerprint `a1473a830dbe` over 62 files.
...
| File | Lines | Purpose |
|---|---|---|
| `.claude/skills/qualcomm-case-overview/scripts/cases_overview.mjs` | 1919 | Aggregation engine, CLI summary table, and offline HTML dashboard for Qualcomm cases. |
...
| `tests/cases_overview_render.test.mjs` | 443 | Unit and integration tests for cases_overview rendering (HTML Dashboard & CLI table). |
