...
> Source fingerprint `ad4fe4046a7b` over 58 files.
...
| `.claude/skills/qualcomm-case-overview/scripts/overview_store.mjs` | 347 | Data/domain module: scans case directories, shapes overview records, computes stats, and persists the aggregated _overview.json atomically. |
