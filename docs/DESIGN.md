...
> Source fingerprint `e4c057a9710e` over 56 files.
...
| `.claude/skills/qualcomm-case-agent/scripts/render_case.mjs` | 81 | deterministic markdown renderer for the Qualcomm Case Management Agent. |
...
| `tests/render_case.test.mjs` | 259 | QA coverage for render_case.mjs Tests that render_case.mjs generates ONLY case.md (clean markdown) with Header metadata, Initial Description, and Chronological Timeline of comments, without generating HTML, PDF, txt, or report.md files. |
