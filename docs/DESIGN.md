...
> Source fingerprint `57927e9fe241` over 33 files.
...
| `.claude/skills/qualcomm-case-agent/scripts/extract_case.js` | 194 | Default case extractor for PHASE 2. |
...
| `tests/extract_case.test.mjs` | 397 | — |
