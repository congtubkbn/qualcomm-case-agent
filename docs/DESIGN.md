...
> Source fingerprint `09dfc3684ce0` over 86 files.
...
| `.claude/skills/qcomm/scripts/extract_case.js` | 482 | Default case extractor for PHASE 2. |
...
| `tests/qcomm_extract_case.test.mjs` | 1877 | — |
