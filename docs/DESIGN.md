...
> Source fingerprint `e3e577145504` over 86 files.
...
| `.claude/skills/qcomm/scripts/run_summary.mjs` | 327 | orchestrator for qcomm summary. |
...
| `tests/qcomm_summary_orchestrator.test.mjs` | 430 | Tests for qcomm's orchestrator (prepare/finalize). |
