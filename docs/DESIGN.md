...
> Source fingerprint `060a345b6225` over 58 files.
...
| `.claude/skills/qualcomm-case-agent/scripts/render_case.mjs` | 197 | deterministic markdown renderer for the Qualcomm Case Management Agent. |
...
| `.claude/skills/qualcomm-case-summary/scripts/render_summary.mjs` | 50 | pure summary.md renderer for qualcomm-case-summary. |
...
| `tests/render_case.test.mjs` | 612 | QA coverage for render_case.mjs Tests that render_case.mjs generates ONLY case.md (clean markdown) with Header metadata, Initial Description, and Chronological Timeline of comments, without generating HTML, PDF, txt, or report.md files. |
