...
> Source fingerprint `7cdd1b9622c5` over 52 files.
...
| File | Lines | Purpose |
|---|---|---|
| `.claude/skills/qualcomm-case-overview/scripts/cases_overview.mjs` | 1311 | Aggregation engine, CLI summary table, and offline HTML dashboard for Qualcomm cases. |
...
| `tests/cases_overview_render.test.mjs` | 269 | Unit and integration tests for cases_overview rendering (HTML Dashboard & CLI table). |
