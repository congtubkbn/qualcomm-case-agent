...
> Source fingerprint `dbbd2844f2f7` over 65 files.
...
| `.claude/skills/qualcomm-case-agent/scripts/fast_landing.mjs` | 466 | Deep Module: Direct Nav + Event-Driven Search & Landing Engine. |
