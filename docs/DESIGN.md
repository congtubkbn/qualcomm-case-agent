...
> Source fingerprint `1dab0ac08818` over 60 files.
...
| File | Lines | Purpose |
|---|---|---|
| `.claude/skills/qualcomm-case-overview/scripts/cases_overview.mjs` | 1920 | Aggregation engine, CLI summary table, and offline HTML dashboard for Qualcomm cases. |
