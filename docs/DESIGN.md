...
> Source fingerprint `4cddf742d149` over 59 files.
...
| `.claude/skills/qualcomm-case-agent/scripts/run_case.mjs` | 615 | the whole capture pipeline as ONE deterministic command. |
...
| File | Lines | Purpose |
|---|---|---|
| `.claude/skills/qualcomm-case-overview/scripts/cases_overview.mjs` | 1560 | Aggregation engine, CLI summary table, and offline HTML dashboard for Qualcomm cases. |
