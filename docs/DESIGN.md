...
> Source fingerprint `201412132e7a` over 46 files.
...
| `tests/cases_overview_data.test.mjs` | 420 | Unit and integration tests for cases_overview data scanning and aggregation engine. |
| `tests/cases_overview_e2e.test.mjs` | 263 | End-to-end integration tests for cases_overview: 1. |
| `tests/cases_overview_render.test.mjs` | 228 | Unit and integration tests for cases_overview rendering (HTML Dashboard & CLI table). |
...
| File | Lines | Purpose |
|---|---|---|
| `tools/cases_overview.mjs` | 1158 | Aggregation engine, CLI summary table, and offline HTML dashboard for Qualcomm cases. |
...
| `npm run cases:overview` | `node tools/cases_overview.mjs` |
| `npm run cases:dashboard` | `node tools/cases_overview.mjs --open` |
