...
> Source fingerprint `04c154dd98ae` over 75 files.
...
| `.claude/skills/qcomm/scripts/run_case.mjs` | 492 | the whole capture pipeline as ONE deterministic command. |
...
| `tests/qcomm_run_case.test.mjs` | 996 | Tests for run_case.mjs's pipeline orchestrator, anchor logic, and stuck detection. |
