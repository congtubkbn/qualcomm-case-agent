...
> Source fingerprint `2c57b292b2b8` over 53 files.
...
| `.claude/skills/qualcomm-case-agent/scripts/render_case.mjs` | 70 | deterministic markdown renderer for the Qualcomm Case Management Agent. |
...
| File | Lines | Purpose |
|---|---|---|
| `.claude/skills/qualcomm-case-overview/scripts/cases_overview.mjs` | 1512 | Aggregation engine, CLI summary table, and offline HTML dashboard for Qualcomm cases. |
...
| `tests/cases_overview_data.test.mjs` | 519 | Unit and integration tests for cases_overview data scanning and aggregation engine. |
| `tests/cases_overview_e2e.test.mjs` | 263 | End-to-end integration tests for cases_overview: 1. |
| `tests/cases_overview_render.test.mjs` | 318 | Unit and integration tests for cases_overview rendering (HTML Dashboard & CLI table). |
...
| `tests/render_case.test.mjs` | 223 | QA coverage for render_case.mjs Tests that render_case.mjs generates ONLY case.md (clean markdown) with Header metadata, Initial Description, and Chronological Timeline of comments, without generating HTML, PDF, txt, or report.md files. |
