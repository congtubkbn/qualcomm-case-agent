...
> Source fingerprint `02b46ff573cb` over 67 files.
...
| `.claude/skills/qualcomm-case-agent/scripts/fast_landing.mjs` | 675 | — |
...
| `tests/fast_landing.test.mjs` | 1231 | — |
...
| `tests/pipeline.test.mjs` | 181 | Unit tests for the headless pipeline's pure logic. |
...
| `tests/run_case.test.mjs` | 794 | Tests for run_case.mjs's pipeline orchestrator, anchor logic, and stuck detection. |
