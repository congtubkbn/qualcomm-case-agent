...
> Source fingerprint `2e531f6afe00` over 60 files.
...
| File | Lines | Purpose |
|---|---|---|
| `.claude/skills/qualcomm-case-overview/scripts/cases_overview.mjs` | 1880 | Aggregation engine, CLI summary table, and offline HTML dashboard for Qualcomm cases. |
...
| `tests/cases_overview_render.test.mjs` | 442 | Unit and integration tests for cases_overview rendering (HTML Dashboard & CLI table). |
