...
> Source fingerprint `1a27849ceac8` over 52 files.
...
| `.claude/skills/qualcomm-case-agent/scripts/scrape_case.mjs` | 785 | Persistence post-processor for the AGENT-DRIVEN extraction. |
...
| File | Lines | Purpose |
|---|---|---|
| `.claude/skills/qualcomm-case-overview/scripts/cases_overview.mjs` | 1172 | Aggregation engine, CLI summary table, and offline HTML dashboard for Qualcomm cases. |
...
| `tests/cases_overview_data.test.mjs` | 422 | Unit and integration tests for cases_overview data scanning and aggregation engine. |
| `tests/cases_overview_e2e.test.mjs` | 263 | End-to-end integration tests for cases_overview: 1. |
| `tests/cases_overview_render.test.mjs` | 230 | Unit and integration tests for cases_overview rendering (HTML Dashboard & CLI table). |
