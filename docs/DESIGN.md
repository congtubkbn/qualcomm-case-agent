...
> Source fingerprint `39c5de605149` over 80 files.
...
| `.claude/skills/qualcomm-case-agent/scripts/finalize_case.mjs` | 993 | Persistence post-processor for the AGENT-DRIVEN extraction. |
...
| `tests/finalize_case.test.mjs` | 1257 | Tests for the finalizer — the module that decides what gets persisted. |
