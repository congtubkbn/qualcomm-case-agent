...
> Source fingerprint `ac27e0d3b77a` over 62 files.
...
| `.claude/skills/qualcomm-case-agent/scripts/browser.mjs` | 251 | thin Node wrapper around the `agent-browser` CLI. |
...
| `tests/run_case.test.mjs` | 793 | Tests for run_case.mjs's pipeline orchestrator, anchor logic, and stuck detection. |
