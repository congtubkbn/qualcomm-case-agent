...
> Source fingerprint `6a77615e3fe1` over 75 files.
...
| `.claude/skills/qcomm/scripts/run_case.mjs` | 535 | the whole capture pipeline as ONE deterministic command. |
...
| `tests/qcomm_run_case.test.mjs` | 1028 | Tests for run_case.mjs's pipeline orchestrator, anchor logic, and stuck detection. |
