...
> Source fingerprint `7713ada4b2c5` over 57 files.
...
| `tools/migrate_case_detail.mjs` | 297 | Upgrade and migrate cached cases with Salesforce Detail tab metadata, re-render case.md with Detail fields, and update case index/overview. |
