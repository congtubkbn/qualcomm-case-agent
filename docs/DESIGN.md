...
> Source fingerprint `e1a4c3f16a0d` over 56 files.
...
| `.claude/skills/qualcomm-case-agent/scripts/scrape_case.mjs` | 863 | Persistence post-processor for the AGENT-DRIVEN extraction. |
...
| `tests/scrape_case.test.mjs` | 843 | Tests for the finalizer — the module that decides what gets persisted. |
