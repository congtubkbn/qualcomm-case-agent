...
> Source fingerprint `843b1598f079` over 81 files.
...
| `tests/qcomm_overview_data.test.mjs` | 745 | Unit and integration tests for cases_overview data scanning and aggregation engine. |
...
| `tests/qcomm_overview_render.test.mjs` | 578 | Unit and integration tests for cases_overview rendering (HTML Dashboard & CLI table). |
