...
> Source fingerprint `ea8ae9a49185` over 57 files.
...
| `.claude/skills/qualcomm-case-agent/scripts/delete_case.mjs` | 100 | permanent, agent-confirmed removal of one case's local cache. |
...
| File | Lines | Purpose |
|---|---|---|
| `.claude/skills/qualcomm-case-overview/scripts/cases_overview.mjs` | 1547 | Aggregation engine, CLI summary table, and offline HTML dashboard for Qualcomm cases. |
...
| `tests/cases_overview_render.test.mjs` | 371 | Unit and integration tests for cases_overview rendering (HTML Dashboard & CLI table). |
