...
> Source fingerprint `60fc82d4a015` over 62 files.
...
| `tests/cases_overview_after_finalize.test.mjs` | 98 | Tests for cases_overview.mjs's afterFinalize — the shared overview/dashboard sync seam both finalize_case.mjs and run_summary.mjs call after a case finalizes. |
