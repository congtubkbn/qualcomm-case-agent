...
> Source fingerprint `a74c900c06fb` over 55 files.
...
| `.claude/skills/qualcomm-case-agent/scripts/extract_case.js` | 306 | Default case extractor for PHASE 2. |
...
| `tests/extract_case.test.mjs` | 885 | — |
