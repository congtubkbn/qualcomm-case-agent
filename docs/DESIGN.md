...
> Source fingerprint `65e536d394c0` over 35 files.
...
| `.claude/skills/qualcomm-case-agent/scripts/fast_landing.mjs` | 434 | Deep Module: Direct Nav + Event-Driven Search & Landing Engine. |
...
| `.claude/skills/qualcomm-case-agent/scripts/run_case.mjs` | 552 | the whole capture pipeline as ONE deterministic command. |
...
| `tests/run_case.test.mjs` | 388 | Tests for run_case.mjs's pipeline orchestrator, anchor logic, and stuck detection. |
