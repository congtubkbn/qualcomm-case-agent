...
> Source fingerprint `e54e9af7f746` over 60 files.
...
| File | Lines | Purpose |
|---|---|---|
| `.claude/skills/qualcomm-case-overview/scripts/cases_overview.mjs` | 1564 | Aggregation engine, CLI summary table, and offline HTML dashboard for Qualcomm cases. |
...
| `tests/cases_overview_render.test.mjs` | 410 | Unit and integration tests for cases_overview rendering (HTML Dashboard & CLI table). |
