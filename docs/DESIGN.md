...
> Source fingerprint `d415335e0c45` over 33 files.
...
| `.claude/skills/qualcomm-case-agent/scripts/fast_landing.mjs` | 150 | Deep Module: Direct Nav + Event-Driven Search & Landing Engine. |
...
| `tests/fast_landing.test.mjs` | 175 | — |
