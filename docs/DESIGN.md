...
> Source fingerprint `468af81a2998` over 83 files.
...
| `.claude/skills/qcomm/scripts/cdp_portal_driver.mjs` | 367 | Production PortalDriver: drives the persistent-profile Chrome over CDP. |
