...
> Source fingerprint `7b783a5a7a4b` over 83 files.
...
| `.claude/skills/qcomm/scripts/cdp_portal_driver.mjs` | 373 | Production PortalDriver: drives the persistent-profile Chrome over CDP. |
