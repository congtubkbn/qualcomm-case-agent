...
> Source fingerprint `48c0275441f2` over 60 files.
...
| File | Lines | Purpose |
|---|---|---|
| `.claude/skills/qualcomm-case-overview/scripts/cases_overview.mjs` | 1925 | Aggregation engine, CLI summary table, and offline HTML dashboard for Qualcomm cases. |
