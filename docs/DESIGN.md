...
> Source fingerprint `4a1584d5c1e3` over 75 files.
...
| `.claude/skills/qualcomm-case-agent/scripts/finalize_case.mjs` | 1013 | Persistence post-processor for the AGENT-DRIVEN extraction. |
...
| `.claude/skills/qualcomm-case-overview/scripts/overview_store.mjs` | 412 | Data/domain module: scans case directories, shapes overview records, computes stats, and persists the aggregated _overview.json atomically. |
