...
> Source fingerprint `9528a620dcfe` over 77 files.
...
| `.claude/skills/qualcomm-case-overview/scripts/overview_store.mjs` | 429 | Data/domain module: scans case directories, shapes overview records, computes stats, and persists the aggregated _overview.json atomically. |
