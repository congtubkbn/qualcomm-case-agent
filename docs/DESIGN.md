...
> Source fingerprint `a7cee558e014` over 86 files.
...
| `.claude/skills/qcomm/scripts/run_summary.mjs` | 306 | orchestrator for qcomm summary. |
...
| `tests/qcomm_summary_merge.test.mjs` | 240 | Tests for qcomm's merge logic (pure, no mocking needed). |
