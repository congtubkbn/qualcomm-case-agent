...
> Source fingerprint `acaf1f0e1e60` over 81 files.
...
| `.claude/skills/qcomm/scripts/cdp_portal_driver.mjs` | 343 | production PortalDriver: drives the persistent- profile Chrome over CDP. |
...
| `.claude/skills/qcomm/scripts/dom_extractor.js` | 1052 | Unified, namespaced DOM extractor and browser automation helper module. |
