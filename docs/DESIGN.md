...
> Source fingerprint `34fd539a8104` over 25 files.
...
| `.claude/skills/qualcomm-case-agent/scripts/okta_login.ps1` | 110 | drive Qualcomm Okta identifier-first login through the password step using the DPAPI-stored credential. |
...
| `.claude/skills/qualcomm-case-agent/scripts/run_case.mjs` | 271 | the whole capture pipeline as ONE deterministic command. |
