...
> Source fingerprint `af5d70aa7391` over 52 files.
...
| File | Lines | Purpose |
|---|---|---|
| `.claude/skills/qualcomm-case-overview/scripts/cases_overview.mjs` | 1183 | Aggregation engine, CLI summary table, and offline HTML dashboard for Qualcomm cases. |
...
| `tests/cases_overview_render.test.mjs` | 247 | Unit and integration tests for cases_overview rendering (HTML Dashboard & CLI table). |
