...
> Source fingerprint `39ed8e751e24` over 55 files.
...
| `.claude/skills/qualcomm-case-agent/scripts/run_case.mjs` | 574 | the whole capture pipeline as ONE deterministic command. |
...
| `tests/run_case.test.mjs` | 513 | Tests for run_case.mjs's pipeline orchestrator, anchor logic, and stuck detection. |
