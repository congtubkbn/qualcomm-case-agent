...
> Source fingerprint `a251ff4b7650` over 60 files.
...
| `.claude/skills/qualcomm-case-agent/scripts/scrape_case.mjs` | 1012 | Persistence post-processor for the AGENT-DRIVEN extraction. |
...
| File | Lines | Purpose |
|---|---|---|
| `.claude/skills/qualcomm-case-summary/scripts/run_summary.mjs` | 235 | orchestrator for qualcomm-case-summary. |
...
| File | Lines | Purpose |
|---|---|---|
| `.claude/skills/qualcomm-case-overview/scripts/cases_overview.mjs` | 153 | CLI orchestrator: wires the overview store, dashboard renderer, and CLI table renderer together into the `cases_overview` command. |
