...
> Source fingerprint `7b0ec5954cfd` over 81 files.
...
| `.claude/skills/qcomm/scripts/overview_store.mjs` | 457 | Data/domain module: scans case directories, shapes overview records, computes stats, and persists the aggregated _overview.json atomically. |
...
| `.claude/skills/qcomm/scripts/run_summary.mjs` | 261 | orchestrator for qualcomm-case-summary. |
